...
& $buildPython -m PyInstaller `
    ...
    --name "disk-space-growth-monitor-v0.8.2" `
    run.py
...
Write-Host "打包完成："
Write-Host "  dist\disk-space-growth-monitor-v0.8.2.exe"
Write-Host "  dist\diskmonitor-cli-v0.8.2.exe"
